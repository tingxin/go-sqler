...
func TestInsert1(t *testing.T) {
	...
	str := query.String()
	expected := `INSERT INTO users ( name,age,sex,birthday,is_employee ) VALUES ("barry",30,"male","1987-01-15",true),("edwin",35,"male","1982-01-15",true),("stacy",32.5,"female","1986-01-15",true)`
	if str != expected {
		t.Errorf("\nExpected:\n%s\nActually:\n%s\n", expected, str)
	}
}
